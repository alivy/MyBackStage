...
namespace WebSite.Controllers.HomeAciton
{
    ...
    public class LogionAction : BaseAction
    {
        ...
        public LogionAction(ISys_UserBLL<Sys_User> sys_UserBLL)
        {
            userBll = sys_UserBLL;
        }
        ...
        public ActionResult Action(ViewUserLogin viewUser)
        {
            ...
            int m_userId = (int)SessionManager.Get(ConstString.UserLoginId);
            ...
            return new RedirectResult("/ShowBoard/Index");
        }
